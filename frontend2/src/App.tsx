...
const App: React.FC = () => {
  ...
  const [scanSpeedMs, setScanSpeedMs] = useState<number>(1800);
  ...
  const exportToJSON = () => {
    ...
    const link = document.createElement("a");
    link.setAttribute("href", url);
    link.setAttribute("download", `WasteWise_TACO_Backup_${new Date().toISOString().slice(0, 10)}.json`);
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
      ...
      <header className="app-header">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <button
            ...
            title="Browse 60 TACO Dataset Classes"
          >
              ...
              <div className="camera-wrapper">
                {isCameraOn ? (
                  ...
                  <div className="camera-off-placeholder">
                    ...
                    <p style={{ fontWeight: 600 }}>TACO Vision Scanner Standby</p>
                    <p style={{ fontSize: "0.8rem" }}>
                      Start camera to identify litter via TACO taxonomy
                    </p>
                  </div>
                )}
              </div>
              ...
              {topDetection ? (
                <div className="result-card">
                    ...
                    <div className="result-left">
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: "0.75rem", color: "var(--muted)", fontWeight: 600 }}>
                          TACO Supercategory: <b>{topDetection.supercategory || "Litter"}</b> • Material: <b>{topDetection.material || "Packaging"}</b>
                        </div>
                  ...
                  <div className="confidence-bar-wrap">
                    <div className="confidence-label">
                      <span>TACO Classification Confidence</span>
                ...
                <div className="glass-card" style={{ padding: "20px", textAlign: "center", marginBottom: 20 }}>
                  <p style={{ fontSize: "0.85rem", color: "var(--muted)" }}>
                    {isCameraOn
                      ? "🔍 Scanning frame with TACO Vision Engine... Point your camera at a waste item."
                      ...
                      <tr>
                        <td colSpan={11} className="empty-table">
                          ...
                          <p style={{ fontSize: "0.8rem", marginTop: 4 }}>
                            Scan items using the TACO engine or click &quot;Add Record&quot; above.
                          </p>
                        </td>
                      </tr>
                    )}
        ...
        <div className="modal-backdrop" onClick={() => setTaxonomyModalOpen(false)}>
          ...
          >
            <div className="modal-header">
              <div>
                <div className="modal-title" style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  <BookOpen size={20} color="var(--primary)" /> TACO Dataset Taxonomy
                </div>
                <div style={{ fontSize: "0.78rem", color: "var(--muted)", marginTop: 2 }}>
                  60 Fine-grained Categories across 28 Supercategories mapped to Circular Streams
                </div>
              </div>
              <button
            ...
            <div style={{ marginBottom: 14 }}>
              <input
                type="text"
                placeholder="Search TACO categories (e.g. bottle, can, paper, battery)..."
          ...
          <div className="modal-box" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={saveEditedRecord}>
              <div className="form-group">
                <label className="form-label">TACO Item Description</label>
                <input
                  type="text"
                  required
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                <div className="form-group">
                  <label className="form-label">TACO Supercategory</label>
                  <input
                    type="text"
        ...
        <div className="modal-backdrop" onClick={() => setClearConfirmOpen(false)}>
          <div className="modal-box" style={{ maxWidth: 400 }} onClick={(e) => e.stopPropagation()}>
            <div className="modal-title" style={{ color: "var(--eco-red)", display: "flex", alignItems: "center", gap: 8 }}>
              <AlertTriangle size={20} /> Clear TACO Spreadsheet Data?
            </div>
